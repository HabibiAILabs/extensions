...
| --- | ---: | --- |
| [`chat`](chat/) | `0.2.2` | Multi-session web chat with owned context and tool-suggestion hooks. |
...
| [`web-search`](web-search/) | `0.1.4` | Brave or self-hosted SearXNG public-web discovery. |
